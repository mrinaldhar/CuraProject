...
<div id="manageeventsp" class="pageitem">
	...
	<table id="managetable">
		<tr><td><br /><input type="text" name="subject" id="subject" placeholder="Subject" /><textarea id="message" name="message" placeholder="Message Content goes here."></textarea><br /><br /><button name="sendmsg" id="sendmsg" onclick="sendmsg()">Post this Update</button></td></tr>
